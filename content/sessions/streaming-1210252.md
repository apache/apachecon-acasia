...
Kafka uses local centralized storage, while Fluss stores cold data in Paimon. With Paimon’s S3 storage deployed on HDDs, significant storage cost savings are achieved without sacrificing query performance.
